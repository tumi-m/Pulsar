...
export const SAMPLE_CATALOG: CatalogSample[] = [
  ...
  // ── Breakbeat foundations — the records the culture is built on ──
  { artist: "Oasis", title: "D'You Know What I Mean?", sourceArtist: "The Winstons", sourceTitle: "Amen, Brother", sourceYear: "1969", note: "A hidden Amen break buried in the mix" },
  { artist: "LL Cool J", title: "Mama Said Knock You Out", sourceArtist: "James Brown", sourceTitle: "Funky Drummer", sourceYear: "1970", note: "The unstoppable snare pattern" },
  { artist: "En Vogue", title: "My Lovin' (You're Never Gonna Get It)", sourceArtist: "James Brown", sourceTitle: "The Payback", sourceYear: "1973", note: "The guitar groove" },
  { artist: "Rob Base & DJ E-Z Rock", title: "It Takes Two", sourceArtist: "Lyn Collins", sourceTitle: "Think (About It)", sourceYear: "1972", note: "'It takes two to make a thing go right' — the whole hook" },
  { artist: "Run-DMC", title: "Peter Piper", sourceArtist: "Bob James", sourceTitle: "Take Me to the Mardi Gras", sourceYear: "1975", note: "The bells-and-bells break that launched a thousand B-boy sets" },
  { artist: "Ghostface Killah", title: "Daytona 500", sourceArtist: "Bob James", sourceTitle: "Nautilus", sourceYear: "1974", note: "The deep jazz-funk loop" },
  { artist: "Nas", title: "Made You Look", sourceArtist: "The Incredible Bongo Band", sourceTitle: "Apache", sourceYear: "1973", note: "The bongo-driven funk break" },
  { artist: "Sugarhill Gang", title: "Apache", sourceArtist: "The Incredible Bongo Band", sourceTitle: "Apache", sourceYear: "1973", partial: true, note: "Replayed by the Sugarhill house band" },
  { artist: "Beastie Boys", title: "Rhymin' and Stealin'", sourceArtist: "Led Zeppelin", sourceTitle: "When the Levee Breaks", sourceYear: "1971", note: "The Bonham drum stomp" },
  { artist: "Afrika Bambaataa & the Soulsonic Force", title: "Planet Rock", sourceArtist: "Kraftwerk", sourceTitle: "Trans-Europe Express", sourceYear: "1977", note: "The melody that birthed electro" },
  { artist: "Afrika Bambaataa & the Soulsonic Force", title: "Planet Rock", sourceArtist: "Kraftwerk", sourceTitle: "Numbers", sourceYear: "1983", note: "The robotik drum machine pattern" },
  { artist: "Digital Underground", title: "The Humpty Dance", sourceArtist: "Sly & the Family Stone", sourceTitle: "Sing a Simple Song", sourceYear: "1968", note: "The funk bassline" },
  { artist: "EPMD", title: "You Gots to Chill", sourceArtist: "Zapp", sourceTitle: "More Bounce to the Ounce", sourceYear: "1980", note: "The talkbox electro-funk groove" },
  { artist: "De La Soul", title: "Me, Myself and I", sourceArtist: "Ohio Players", sourceTitle: "Funky Worm", sourceYear: "1972", note: "The whining synth lead" },
  { artist: "De La Soul", title: "Me, Myself and I", sourceArtist: "Edwin Birdsong", sourceTitle: "Rapper Dapper Snapper", sourceYear: "1979" },
  { artist: "Grandmaster Flash & the Furious Five", title: "The Message", sourceArtist: "Liquid Liquid", sourceTitle: "Cavern", sourceYear: "1983", partial: true, note: "The iconic bassline (interpolated — and litigated)" },
  { artist: "Ice Cube", title: "Check Yo Self", sourceArtist: "Grandmaster Flash & the Furious Five", sourceTitle: "The Message", sourceYear: "1982", note: "The synth riff looped" },
  { artist: "DNA", title: "Tom's Diner", sourceArtist: "Suzanne Vega", sourceTitle: "Tom's Diner", sourceYear: "1987", note: "The a cappella grafted onto a house groove" },
  { artist: "Mary J. Blige", title: "Real Love", sourceArtist: "Betty Wright", sourceTitle: "Clean Up Woman", sourceYear: "1971", note: "The clipped guitar riff" },

  // ── Pop crossovers — samples everyone knows without knowing ──
  { artist: "SWV", title: "Right Here (Human Nature Remix)", sourceArtist: "Michael Jackson", sourceTitle: "Human Nature", sourceYear: "1983", note: "The synths and piano of the Thriller ballad" },
  { artist: "Nas", title: "It Ain't Hard to Tell", sourceArtist: "Michael Jackson", sourceTitle: "Human Nature", sourceYear: "1983", note: "The shimmering synth line" },
  { artist: "Destiny's Child", title: "Bootylicious", sourceArtist: "Stevie Nicks", sourceTitle: "Edge of Seventeen", sourceYear: "1981", note: "The jagged guitar riff" },
  { artist: "Eminem", title: "My Name Is", sourceArtist: "Labi Siffre", sourceTitle: "I Got The...", sourceYear: "1975", note: "The lazy bass-and-keys groove" },
  { artist: "Kanye West", title: "Good Life", sourceArtist: "Michael Jackson", sourceTitle: "P.Y.T. (Pretty Young Thing)", sourceYear: "1982", note: "The pitched-up riff" },
  { artist: "Kanye West", title: "Touch the Sky", sourceArtist: "Curtis Mayfield", sourceTitle: "Move On Up", sourceYear: "1970", note: "The horns-and-bongos uplift" },
  { artist: "Kanye West", title: "Father Stretch My Hands, Pt. 1", sourceArtist: "Pastor T.L. Barrett", sourceTitle: "Father I Stretch My Hands", sourceYear: "1974", note: "The gospel choir loop" },
  { artist: "The Verve", title: "Bitter Sweet Symphony", sourceArtist: "Andrew Loog Oldham Orchestra", sourceTitle: "The Last Time", sourceYear: "1966", note: "The string loop — famously 100% of the royalties until 2019" },
  { artist: "Montell Jordan", title: "This Is How We Do It", sourceArtist: "Slick Rick", sourceTitle: "Children's Story", sourceYear: "1988", note: "The bassline bounce" },
  { artist: "The Notorious B.I.G.", title: "Mo Money Mo Problems", sourceArtist: "Diana Ross", sourceTitle: "I'm Coming Out", sourceYear: "1980", note: "The disco strings and horns" },
  { artist: "Jay-Z", title: "Hard Knock Life (Ghetto Anthem)", sourceArtist: "Cast of Annie", sourceTitle: "It's a Hard Knock Life", sourceYear: "1977", note: "The Broadway orphan chorus" },
  { artist: "Jay-Z", title: "Empire State of Mind", sourceArtist: "The Moments", sourceTitle: "Love on a Two-Way Street", sourceYear: "1970", note: "The soulful piano intro" },
  { artist: "Luniz", title: "I Got 5 on It", sourceArtist: "Club Nouveau", sourceTitle: "Why You Treat Me So Bad", sourceYear: "1987", note: "The synth riff, pitched and chopped" },
  { artist: "Club Nouveau", title: "Why You Treat Me So Bad", sourceArtist: "Timex Social Club", sourceTitle: "Rumors", sourceYear: "1986", note: "Its own famous interpolation" },
  { artist: "Mario Winans", title: "I Don't Wanna Know", sourceArtist: "Enya", sourceTitle: "Boadicea", sourceYear: "1987", note: "The same Enya loop the Fugees used" },

  // ── Dance / electronic — chains worth walking ──
  { artist: "Avicii", title: "Levels", sourceArtist: "Etta James", sourceTitle: "Something's Got a Hold on Me", sourceYear: "1962", note: "The vocal that defined EDM's biggest era" },
  { artist: "Flo Rida", title: "Good Feeling", sourceArtist: "Etta James", sourceTitle: "Something's Got a Hold on Me", sourceYear: "1962", note: "The same Etta vocal, rap-radio edition" },
  { artist: "Stardust", title: "Music Sounds Better with You", sourceArtist: "Chaka Khan", sourceTitle: "Fate", sourceYear: "1976", note: "The filtered guitar loop of French house" },
  { artist: "Daft Punk", title: "Harder, Better, Faster, Stronger", sourceArtist: "Edwin Birdsong", sourceTitle: "Cola Bottle Baby", sourceYear: "1979", note: "The funk keyboard riff, vocoded" },
  { artist: "Missy Elliott", title: "Lose Control", sourceArtist: "Cybotron", sourceTitle: "Clear", sourceYear: "1983", note: "The Detroit electro riff" },
  { artist: "Chemical Brothers", title: "Galvanize", sourceArtist: "Najat Aatabou", sourceTitle: "Hadi Kedba Bayna", sourceYear: "1983", note: "The Moroccan vocal over a floor-shaking beat" },
  { artist: "Kendrick Lamar", title: "Money Trees", sourceArtist: "Beach House", sourceTitle: "Silver Soul", sourceYear: "2010", note: "The dream-pop guitar, pitched down" },
  { artist: "Kendrick Lamar", title: "Wesley's Theory", sourceArtist: "Boris Gardiner", sourceTitle: "Every Nigger Is a Star", sourceYear: "1973", note: "The opening funk strut" },
  { artist: "A Tribe Called Quest", title: "Check the Rhime", sourceArtist: "Minnie Riperton", sourceTitle: "Baby, This Love I Have", sourceYear: "1975", note: "The floaty soul groove" },
  { artist: "Snoop Dogg", title: "Gin and Juice", sourceArtist: "George McCrae", sourceTitle: "I Get Lifted", sourceYear: "1974", note: "The G-funk groove" },
  { artist: "2Pac", title: "Do for Love", sourceArtist: "Bobby Caldwell", sourceTitle: "What You Won't Do for Love", sourceYear: "1978", note: "The blue-eyed soul groove" },
  { artist: "Kendrick Lamar", title: "i", sourceArtist: "The Isley Brothers", sourceTitle: "That Lady, Pt. 1 & 2", sourceYear: "1973", note: "The bright funk guitar riff" },
];
